...
#ADDING ALL NEEDED COLUMNS TO AIMDATA CSV
...
BHN<-count(BH,PrimaryKey)
BHN2<-sum(BHN$n)
LBN<-count(LB,PrimaryKey)
LBN2<-sum(LBN$n)
LOAN<-count(LOA,PrimaryKey)
LOAN2<-sum(LOAN$n)
MON<-count(MO,PrimaryKey)
MON2<-sum(MON$n)
OTHN<-count(OTH,PrimaryKey)
OTHN2<-sum(OTHN$n)
ROFN<-count(ROF,PrimaryKey)
ROFN2<-sum(ROFN$n)
SALN<-count(SAL,PrimaryKey)
SALN2<-sum(SALN$n)
SANN<-count(SAN,PrimaryKey)
SANN2<-sum(SANN$n)
FOREN<-count(FORE,PrimaryKey)
FOREN2<-sum(FOREN$n)
...
#if there is no dominant species for the growth form list "N/A" as seen below in domherme<-"N/A"
...
#replace with your species code (see BH strata for more detail)
domgrassme<-c(round(mean(LOAA$Species=="ACSC11", na.rm=TRUE), digits=2),round(mean(LOAA$Species=="ELEL5", na.rm=TRUE), digits=2),round(mean(LOAA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbme<-"N/A"
domwoodme<-c(round(mean(LOAA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassma<-c(round(max(LOAA$Species=="ACSC11", na.rm=TRUE), digits=2),round(max(LOAA$Species=="ELEL5", na.rm=TRUE), digits=2),round(max(LOAA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbma<-"N/A"
domwoodma<-c(round(max(LOAA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassmi<-c(round(min(LOAA$Species=="ACSC11", na.rm=TRUE), digits=2),round(min(LOAA$Species=="ELEL5", na.rm=TRUE), digits=2),round(min(LOAA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbmi<-"N/A"
domwoodmi<-c(round(min(LOAA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrasssd<-c(round(sd(LOAA$Species=="ACSC11", na.rm=TRUE), digits=2),round(sd(LOAA$Species=="ELEL5", na.rm=TRUE), digits=2),round(sd(LOAA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbsd<-"N/A"
domwoodsd<-c(round(sd(LOAA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassCI<-c(round((1.282*(sd(LOAA$Species=="ACSC11", na.rm=TRUE)/LOAN2)),digits = 2) , round((1.282*(sd(LOAA$Species=="ELEL5", na.rm=TRUE)/LOAN2)),digits=2), round((1.282*(sd(LOAA$Species=="AGCR", na.rm=TRUE)/LOAN2)),digits=2))
domherbCI<-"N/A"
...
domgrassme<-c(round(mean(MOA$Species=="ACSC11", na.rm=TRUE), digits=2),round(mean(MOA$Species=="ELEL5", na.rm=TRUE), digits=2),round(mean(MOA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbme<-"N/A"
domwoodme<-c(round(mean(MOA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassma<-c(round(max(MOA$Species=="ACSC11", na.rm=TRUE), digits=2),round(max(MOA$Species=="ELEL5", na.rm=TRUE), digits=2),round(max(MOA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbma<-"N/A"
domwoodma<-c(round(max(MOA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassmi<-c(round(min(MOA$Species=="ACSC11", na.rm=TRUE), digits=2),round(min(MOA$Species=="ELEL5", na.rm=TRUE), digits=2),round(min(MOA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbmi<-"N/A"
domwoodmi<-c(round(min(MOA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrasssd<-c(round(sd(MOA$Species=="ACSC11", na.rm=TRUE), digits=2),round(sd(MOA$Species=="ELEL5", na.rm=TRUE), digits=2),round(sd(MOA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbsd<-"N/A"
domwoodsd<-c(round(sd(MOA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassCI<-c(round((1.282*(sd(MOA$Species=="ACSC11", na.rm=TRUE)/MON2)),digits = 2) , round((1.282*(sd(MOA$Species=="ELEL5", na.rm=TRUE)/MON2)),digits=2), round((1.282*(sd(MOA$Species=="AGCR", na.rm=TRUE)/MON2)),digits=2))
domherbCI<-"N/A"
domwoodCI<-c(round((1.282*(sd(MOA$Species=="ARTRV", na.rm=TRUE)/MON2)),digits=2))
...
domgrassme<-c(round(mean(OTHA$Species=="ACSC11", na.rm=TRUE), digits=2),round(mean(OTHA$Species=="ELEL5", na.rm=TRUE), digits=2),round(mean(OTHA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbme<-"N/A"
domwoodme<-c(round(mean(OTHA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassma<-c(round(max(OTHA$Species=="ACSC11", na.rm=TRUE), digits=2),round(max(OTHA$Species=="ELEL5", na.rm=TRUE), digits=2),round(max(OTHA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbma<-"N/A"
domwoodma<-c(round(max(OTHA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassmi<-c(round(min(OTHA$Species=="ACSC11", na.rm=TRUE), digits=2),round(min(OTHA$Species=="ELEL5", na.rm=TRUE), digits=2),round(min(OTHA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbmi<-"N/A"
domwoodmi<-c(round(min(OTHA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrasssd<-c(round(sd(OTHA$Species=="ACSC11", na.rm=TRUE), digits=2),round(sd(OTHA$Species=="ELEL5", na.rm=TRUE), digits=2),round(sd(OTHA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbsd<-"N/A"
domwoodsd<-c(round(sd(OTHA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassCI<-c(round((1.282*(sd(OTHA$Species=="ACSC11", na.rm=TRUE)/OTHN2)),digits = 2) , round((1.282*(sd(OTHA$Species=="ELEL5", na.rm=TRUE)/OTHN2)),digits=2), round((1.282*(sd(OTHA$Species=="AGCR", na.rm=TRUE)/OTHN2)),digits=2))
domherbCI<-"N/A"
domwoodCI<-c(round((1.282*(sd(OTHA$Species=="ARTRV", na.rm=TRUE)/OTHN2)),digits=2))
...
domgrassme<-c(round(mean(ROFA$Species=="ACSC11", na.rm=TRUE), digits=2),round(mean(ROFA$Species=="ELEL5", na.rm=TRUE), digits=2),round(mean(ROFA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbme<-"N/A"
domwoodme<-c(round(mean(ROFA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassma<-c(round(max(ROFA$Species=="ACSC11", na.rm=TRUE), digits=2),round(max(ROFA$Species=="ELEL5", na.rm=TRUE), digits=2),round(max(ROFA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbma<-"N/A"
domwoodma<-c(round(max(ROFA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassmi<-c(round(min(ROFA$Species=="ACSC11", na.rm=TRUE), digits=2),round(min(ROFA$Species=="ELEL5", na.rm=TRUE), digits=2),round(min(ROFA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbmi<-"N/A"
domwoodmi<-c(round(min(ROFA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrasssd<-c(round(sd(ROFA$Species=="ACSC11", na.rm=TRUE), digits=2),round(sd(ROFA$Species=="ELEL5", na.rm=TRUE), digits=2),round(sd(ROFA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbsd<-"N/A"
domwoodsd<-c(round(sd(ROFA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassCI<-c(round((1.282*(sd(ROFA$Species=="ACSC11", na.rm=TRUE)/ROFN2)),digits = 2) , round((1.282*(sd(ROFA$Species=="ELEL5", na.rm=TRUE)/ROFN2)),digits=2), round((1.282*(sd(ROFA$Species=="AGCR", na.rm=TRUE)/ROFN2)),digits=2))
domherbCI<-"N/A"
domwoodCI<-c(round((1.282*(sd(ROFA$Species=="ARTRV", na.rm=TRUE)/ROFN2)),digits=2))
...
domgrassme<-c(round(mean(SALA$Species=="ACSC11", na.rm=TRUE), digits=2),round(mean(SALA$Species=="ELEL5", na.rm=TRUE), digits=2),round(mean(SALA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbme<-"N/A"
domwoodme<-c(round(mean(SALA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassma<-c(round(max(SALA$Species=="ACSC11", na.rm=TRUE), digits=2),round(max(SALA$Species=="ELEL5", na.rm=TRUE), digits=2),round(max(SALA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbma<-"N/A"
domwoodma<-c(round(max(SALA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassmi<-c(round(min(SALA$Species=="ACSC11", na.rm=TRUE), digits=2),round(min(SALA$Species=="ELEL5", na.rm=TRUE), digits=2),round(min(SALA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbmi<-"N/A"
domwoodmi<-c(round(min(SALA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrasssd<-c(round(sd(SALA$Species=="ACSC11", na.rm=TRUE), digits=2),round(sd(SALA$Species=="ELEL5", na.rm=TRUE), digits=2),round(sd(SALA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbsd<-"N/A"
domwoodsd<-c(round(sd(SALA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassCI<-c(round((1.282*(sd(SALA$Species=="ACSC11", na.rm=TRUE)/SALN2)),digits = 2) , round((1.282*(sd(SALA$Species=="ELEL5", na.rm=TRUE)/SALN2)),digits=2), round((1.282*(sd(SALA$Species=="AGCR", na.rm=TRUE)/SALN2)),digits=2))
domherbCI<-"N/A"
domwoodCI<-c(round((1.282*(sd(SALA$Species=="ARTRV", na.rm=TRUE)/SALN2)),digits=2))
...
domgrassme<-c(round(mean(SANA$Species=="ACSC11", na.rm=TRUE), digits=2),round(mean(SANA$Species=="ELEL5", na.rm=TRUE), digits=2),round(mean(SANA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbme<-"N/A"
domwoodme<-c(round(mean(SANA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassma<-c(round(max(SANA$Species=="ACSC11", na.rm=TRUE), digits=2),round(max(SANA$Species=="ELEL5", na.rm=TRUE), digits=2),round(max(SANA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbma<-"N/A"
domwoodma<-c(round(max(SANA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassmi<-c(round(min(SANA$Species=="ACSC11", na.rm=TRUE), digits=2),round(min(SANA$Species=="ELEL5", na.rm=TRUE), digits=2),round(min(SANA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbmi<-"N/A"
domwoodmi<-c(round(min(SANA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrasssd<-c(round(sd(SANA$Species=="ACSC11", na.rm=TRUE), digits=2),round(sd(SANA$Species=="ELEL5", na.rm=TRUE), digits=2),round(sd(SANA$Species=="AGCR", na.rm=TRUE), digits=2))
domherbsd<-"N/A"
domwoodsd<-c(round(sd(SANA$Species=="ARTRV", na.rm=TRUE), digits=2))

domgrassCI<-c(round((1.282*(sd(SANA$Species=="ACSC11", na.rm=TRUE)/SANN2)),digits = 2) , round((1.282*(sd(SANA$Species=="ELEL5", na.rm=TRUE)/SANN2)),digits=2), round((1.282*(sd(SANA$Species=="AGCR", na.rm=TRUE)/SANN2)),digits=2))
domherbCI<-"N/A"
domwoodCI<-c(round((1.282*(sd(SANA$Species=="ARTRV", na.rm=TRUE)/SANN2)),digits=2))
