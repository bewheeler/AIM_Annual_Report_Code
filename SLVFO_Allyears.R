...
LOST<-subset(STN,Actual.Eco.Site=="LOA")
...
Indicator<-c("Surface Indicator (%)","Rock Fragment", "Litter","Bare Soil",
             ...
             "Gaps 101-200 cm","Gaps >200 cm", "Canopy Cover (%)",
             "Total Canopy Cover","Species Richness","No. Species per Plot")
Average<-c("",round(mean(LB$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(LB$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(LB$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(mean(LBA$Species=="BOGR2", na.rm=TRUE), digits=2),round(mean(LBA$Species=="PASM", na.rm=TRUE), digits=2),"",round(mean(LBA$Species=="SATR12", na.rm=TRUE), digits=2),"",
           round(mean(LBA$Species=="KRLA2", na.rm=TRUE), digits=2),"",round(mean(LBG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Minimum<-c("",round(min(LB$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(LB$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(LB$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(min(LB$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(min(LB$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(min(LBT$HeightWoody, na.rm=TRUE), digits=2),round(mean(LBS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(min(LBA$Species=="BOGR2", na.rm=TRUE), digits=2),round(min(LBA$Species=="PASM", na.rm=TRUE), digits=2),"",round(min(LBA$Species=="SATR12", na.rm=TRUE), digits=2),"",
           round(min(LBA$Species=="KRLA2", na.rm=TRUE), digits=2),"",round(min(LBG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Maximum<-c("",round(max(LB$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(LB$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(LB$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(max(LB$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(max(LB$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(max(LBT$HeightWoody, na.rm=TRUE), digits=2),round(mean(LBS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(max(LBA$Species=="BOGR2", na.rm=TRUE), digits=2),round(max(LBA$Species=="PASM", na.rm=TRUE), digits=2),"",round(max(LBA$Species=="SATR12", na.rm=TRUE), digits=2),"",
           round(max(LBA$Species=="KRLA2", na.rm=TRUE), digits=2),"",round(max(LBG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
St.Dev.<-c("",round(sd(LB$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(LB$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(LB$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(sd(LB$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(sd(LB$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(sd(LBT$HeightWoody, na.rm=TRUE), digits=2),round(mean(LBS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(sd(LBA$Species=="BOGR2", na.rm=TRUE), digits=2),round(sd(LBA$Species=="PASM", na.rm=TRUE), digits=2),"",round(sd(LBA$Species=="SATR12", na.rm=TRUE), digits=2),"",
           round(sd(LBA$Species=="KRLA2", na.rm=TRUE), digits=2),"",round(sd(LBG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Indicator<-c("Surface Indicator (%)","Rock Fragment", "Litter","Bare Soil",
             ...
             "Gaps 101-200 cm","Gaps >200 cm", "Canopy Cover (%)",
             "Total Canopy Cover","Species Richness","No. Species per Plot")
Average<-c("",round(mean(LOA$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(LOA$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(LOA$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(mean(LOAA$Species=="BOGR2", na.rm=TRUE), digits=2),"",round(mean(LOAA$Species=="MUMO", na.rm=TRUE), digits=2),round(mean(LOAA$Species=="MUTO2", na.rm=TRUE), digits=2),"",
           round(mean(LOAA$Species=="PIED", na.rm=TRUE), digits=2),"",round(mean(LOAG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Minimum<-c("",round(min(LOA$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(LOA$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(LOA$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(min(LOA$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(min(LOA$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(min(LOAT$HeightWoody, na.rm=TRUE), digits=2),round(mean(LOAS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(min(LOAA$Species=="BOGR2", na.rm=TRUE), digits=2),"",round(min(LOAA$Species=="MUMO",na.rm=TRUE),digits=2), round(mean(LOAA$Species=="MUTO", na.rm=TRUE), digits=2),"",
           round(min(LOAA$Species=="PIED", na.rm=TRUE), digits=2),"",round(min(LOAG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Maximum<-c("",round(max(LOA$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(LOA$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(LOA$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(max(LOA$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(max(LOA$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(max(LOAT$HeightWoody, na.rm=TRUE), digits=2),round(mean(LOAS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(max(LOAA$Species=="BOGR2", na.rm=TRUE), digits=2),"",round(max(LOAA$Species=="MUMO",na.rm=TRUE),digits=2), round(mean(LOAA$Species=="MUTO", na.rm=TRUE), digits=2),"",
           round(max(LOAA$Species=="PIED", na.rm=TRUE), digits=2),"",round(max(LOAG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
St.Dev.<-c("",round(sd(LOA$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(LOA$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(LOA$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(sd(LOA$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(sd(LOA$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(sd(LOAT$HeightWoody, na.rm=TRUE), digits=2),round(mean(LOAS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(sd(LOAA$Species=="BOGR2", na.rm=TRUE), digits=2),"",round(sd(LOAA$Species=="MUMO",na.rm=TRUE),digits=2), round(mean(LOAA$Species=="MUTO", na.rm=TRUE), digits=2),"",
           round(sd(LOAA$Species=="PIED", na.rm=TRUE), digits=2),"",round(sd(LOAG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Indicator<-c("Surface Indicator (%)","Rock Fragment", "Litter","Bare Soil",
             ...
             "Gaps 101-200 cm","Gaps >200 cm", "Canopy Cover (%)",
             "Total Canopy Cover","Species Richness","No. Species per Plot")
Average<-c("",round(mean(MO$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(MO$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(MO$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(mean(MOA$Species=="BOGR2", na.rm=TRUE), digits=2),round(mean(MOA$Species=="HECO26", na.rm=TRUE), digits=2),round(mean(MOA$Species=="PASM", na.rm=TRUE), digits=2),"","N/A","",
           round(mean(MOA$Species=="CHGR6", na.rm=TRUE), digits=2),"",round(mean(MOG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Minimum<-c("",round(min(MO$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(MO$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(MO$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(min(MO$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(min(MO$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(min(MOT$HeightWoody, na.rm=TRUE), digits=2),round(mean(MOS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(min(MOA$Species=="BOGR2", na.rm=TRUE), digits=2),round(min(MOA$Species=="HECO26", na.rm=TRUE), digits=2),round(min(MOA$Species=="PASM", na.rm=TRUE), digits=2),"","N/A","",
           round(min(MOA$Species=="CHGR6", na.rm=TRUE), digits=2),"",round(min(MOG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Maximum<-c("",round(max(MO$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(MO$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(MO$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(max(MO$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(max(MO$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(max(MOT$HeightWoody, na.rm=TRUE), digits=2),round(mean(MOS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(max(MOA$Species=="BOGR2", na.rm=TRUE), digits=2),round(max(MOA$Species=="HECO26", na.rm=TRUE), digits=2),round(max(MOA$Species=="PASM", na.rm=TRUE), digits=2),"","N/A","",
           round(max(MOA$Species=="CHGR6", na.rm=TRUE), digits=2),"",round(max(MOG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
St.Dev.<-c("",round(sd(MO$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(MO$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(MO$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(sd(MO$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(sd(MO$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(sd(MOT$HeightWoody, na.rm=TRUE), digits=2),round(mean(MOS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(sd(MOA$Species=="BOGR2", na.rm=TRUE), digits=2),round(sd(MOA$Species=="HECO26", na.rm=TRUE), digits=2),round(sd(MOA$Species=="PASM", na.rm=TRUE), digits=2),"","N/A","",
           round(sd(MOA$Species=="CHGR6", na.rm=TRUE), digits=2),"",round(sd(MOG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Indicator<-c("Surface Indicator (%)","Rock Fragment", "Litter","Bare Soil",
             ...
             "Dominant Woody Cover (%)","PIMI","PIED",
             "Canopy Gaps (%)", "Gaps 25-50 cm", "Gaps 51-100 cm",
             "Gaps 101-200 cm","Gaps >200 cm", "Canopy Cover (%)",
             "Total Canopy Cover","Species Richness","No. Species per Plot")
Average<-c("",round(mean(OTH$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(OTH$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(OTH$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(mean(OTHA$Species=="HECO26", na.rm=TRUE), digits=2),"",round(mean(OTHA$Species=="MUMO", na.rm=TRUE), digits=2),"",
           round(mean(OTHA$Species=="PIMI", na.rm=TRUE), digits=2),round(mean(OTHA$Species=="PIED", na.rm=TRUE), digits=2),"",round(mean(OTHG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Minimum<-c("",round(min(OTH$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(OTH$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(OTH$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(min(OTH$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(min(OTH$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(min(OTHT$HeightWoody, na.rm=TRUE), digits=2),round(mean(OTHS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(min(OTHA$Species=="HECO26", na.rm=TRUE), digits=2),"",round(min(OTHA$Species=="MUMO", na.rm=TRUE), digits=2),"",
           round(min(OTHA$Species=="PIMI", na.rm=TRUE), digits=2),round(min(OTHA$Species=="PIED", na.rm=TRUE), digits=2),"",round(min(OTHG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Maximum<-c("",round(max(OTH$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(OTH$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(OTH$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(max(OTH$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(max(OTH$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(max(OTHT$HeightWoody, na.rm=TRUE), digits=2),round(mean(OTHS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(max(OTHA$Species=="HECO26", na.rm=TRUE), digits=2),"",round(max(OTHA$Species=="MUMO", na.rm=TRUE), digits=2),"",
           round(max(OTHA$Species=="PIMI", na.rm=TRUE), digits=2),round(max(OTHA$Species=="PIED", na.rm=TRUE), digits=2),"",round(max(OTHG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
St.Dev.<-c("",round(sd(OTH$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(OTH$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(OTH$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(sd(OTH$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(sd(OTH$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(sd(OTHT$HeightWoody, na.rm=TRUE), digits=2),round(mean(OTHS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(sd(OTHA$Species=="HECO26", na.rm=TRUE), digits=2),"",round(sd(OTHA$Species=="MUMO", na.rm=TRUE), digits=2),"",
           round(sd(OTHA$Species=="PIMI", na.rm=TRUE), digits=2),round(sd(OTHA$Species=="PIED", na.rm=TRUE), digits=2),"",round(sd(OTHG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Indicator<-c("Surface Indicator (%)","Rock Fragment", "Litter","Bare Soil",
             ...
             "Gaps 101-200 cm","Gaps >200 cm", "Canopy Cover (%)",
             "Total Canopy Cover","Species Richness","No. Species per Plot")
Average<-c("",round(mean(ROF$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(ROF$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(ROF$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(mean(ROFA$Species=="HECO26", na.rm=TRUE), digits=2), round(mean(ROFA$Species=="BOGR2", na.rm=TRUE), digits=2),"","N/A","",
           round(mean(ROFA$Species=="PIED", na.rm=TRUE), digits=2),round(mean(ROFA$Species=="JUMO", na.rm=TRUE), digits=2),"",round(mean(ROFG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Minimum<-c("",round(min(ROF$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(ROF$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(ROF$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(min(ROF$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(min(ROF$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(min(ROFT$HeightWoody, na.rm=TRUE), digits=2),round(mean(ROFS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(min(ROFA$Species=="HECO26", na.rm=TRUE), digits=2),round(min(ROFA$Species=="BOGR2", na.rm=TRUE), digits=2),"","N/A","",
           round(min(ROFA$Species=="PIED", na.rm=TRUE), digits=2),round(min(ROFA$Species=="JUMO", na.rm=TRUE), digits=2),"",round(min(ROFG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Maximum<-c("",round(max(ROF$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(ROF$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(ROF$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(max(ROF$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(max(ROF$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(max(ROFT$HeightWoody, na.rm=TRUE), digits=2),round(mean(ROFS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(max(ROFA$Species=="HECO26", na.rm=TRUE), digits=2),round(max(ROFA$Species=="BOGR2", na.rm=TRUE), digits=2),"","N/A","",
           round(max(ROFA$Species=="PIED", na.rm=TRUE), digits=2),round(max(ROFA$Species=="JUMO", na.rm=TRUE), digits=2),"",round(max(ROFG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
St.Dev.<-c("",round(sd(ROF$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(ROF$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(ROF$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(sd(ROF$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(sd(ROF$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(sd(ROFT$HeightWoody, na.rm=TRUE), digits=2),round(mean(ROFS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(sd(ROFA$Species=="HECO26", na.rm=TRUE), digits=2),round(sd(ROFA$Species=="BOGR2", na.rm=TRUE), digits=2),"","N/A","",
           round(sd(ROFA$Species=="PIED", na.rm=TRUE), digits=2),round(sd(ROFA$Species=="JUMO", na.rm=TRUE), digits=2),"",round(sd(ROFG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Indicator<-c("Surface Indicator (%)","Rock Fragment", "Litter","Bare Soil",
             ...
             "Gaps 101-200 cm","Gaps >200 cm", "Canopy Cover (%)",
             "Total Canopy Cover","Species Richness","No. Species per Plot")
Average<-c("",round(mean(SAL$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(SAL$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(SAL$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(mean(SALA$Species=="DISP", na.rm=TRUE), digits=2),"",round(mean(SALA$Species=="ERCE2", na.rm=TRUE), digits=2),"",
           round(mean(SALA$Species=="SAVE4", na.rm=TRUE), digits=2),"",round(mean(SALG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Minimum<-c("",round(min(SAL$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(SAL$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(SAL$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(min(SAL$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(min(SAL$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(min(SALT$HeightWoody, na.rm=TRUE), digits=2),round(mean(SALS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(min(SALA$Species=="DISP", na.rm=TRUE), digits=2),"",round(min(SALA$Species=="ERCE2", na.rm=TRUE), digits=2),"",
           round(min(SALA$Species=="SAVE4", na.rm=TRUE), digits=2),"",round(min(SALG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Maximum<-c("",round(max(SAL$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(SAL$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(SAL$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(max(SAL$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(max(SAL$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(max(SALT$HeightWoody, na.rm=TRUE), digits=2),round(mean(SALS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(max(SALA$Species=="DISP", na.rm=TRUE), digits=2),"",round(max(SALA$Species=="ERCE2", na.rm=TRUE), digits=2),"",
           round(max(SALA$Species=="SAVE4", na.rm=TRUE), digits=2),"",round(max(SALG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
St.Dev.<-c("",round(sd(SAL$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(SAL$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(SAL$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(sd(SAL$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(sd(SAL$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(sd(SALT$HeightWoody, na.rm=TRUE), digits=2),round(mean(SALS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(sd(SALA$Species=="DISP", na.rm=TRUE), digits=2),"",round(sd(SALA$Species=="ERCE2", na.rm=TRUE), digits=2),"",
           round(sd(SALA$Species=="SAVE4", na.rm=TRUE), digits=2),"",round(sd(SALG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Indicator<-c("Surface Indicator (%)","Rock Fragment", "Litter","Bare Soil",
             ...
             "Dominant Herb. Cover (%)", "N/A",
             "Dominant Woody Cover (%)","N/A",
             "Canopy Gaps (%)", "Gaps 25-50 cm", "Gaps 51-100 cm",
             "Gaps 101-200 cm","Gaps >200 cm", "Canopy Cover (%)",
             "Total Canopy Cover","Species Richness","No. Species per Plot")
Average<-c("",round(mean(SAN$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(SAN$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(SAN$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(mean(SANA$Species=="BOGR2", na.rm=TRUE), digits=2),round(mean(SANA$Species=="DISP", na.rm=TRUE), digits=2),round(mean(SANA$Species=="ACHY", na.rm=TRUE), digits=2),round(mean(SANA$Species=="SPCR", na.rm=TRUE), digits=2),
           "","N/A","",
           "N/A","",round(mean(SANG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Minimum<-c("",round(min(SAN$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(SAN$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(SAN$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(min(SAN$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(min(SAN$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(min(SANT$HeightWoody, na.rm=TRUE), digits=2),round(mean(SANS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(min(SANA$Species=="BOGR2", na.rm=TRUE), digits=2),round(min(SANA$Species=="DISP", na.rm=TRUE), digits=2),round(min(SANA$Species=="ACHY", na.rm=TRUE), digits=2),round(min(SANA$Species=="SPCR", na.rm=TRUE), digits=2),
           "","N/A","",
           "N/A","",round(min(SANG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Maximum<-c("",round(max(SAN$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(SAN$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(SAN$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(max(SAN$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(max(SAN$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(max(SANT$HeightWoody, na.rm=TRUE), digits=2),round(mean(SANS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(max(SANA$Species=="BOGR2", na.rm=TRUE), digits=2),round(max(SANA$Species=="DISP", na.rm=TRUE), digits=2),round(max(SANA$Species=="ACHY", na.rm=TRUE), digits=2),round(max(SANA$Species=="SPCR", na.rm=TRUE), digits=2),
           "","N/A","",
           "N/A","",round(max(SANG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
St.Dev.<-c("",round(sd(SAN$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(SAN$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(SAN$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(sd(SAN$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(sd(SAN$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(sd(SANT$HeightWoody, na.rm=TRUE), digits=2),round(mean(SANS$HeightWoody, na.rm=TRUE), digits=2),"",
           round(sd(SANA$Species=="BOGR2", na.rm=TRUE), digits=2),round(sd(SANA$Species=="DISP", na.rm=TRUE), digits=2),round(sd(SANA$Species=="ACHY", na.rm=TRUE), digits=2),round(sd(SANA$Species=="SPCR", na.rm=TRUE), digits=2),
           "","N/A","",
           "N/A","",round(sd(SANG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Indicator<-c("Surface Indicator (%)","Rock Fragment", "Litter","Bare Soil",
             ...
             "Gaps 101-200 cm","Gaps >200 cm", "Canopy Cover (%)",
             "Total Canopy Cover","Species Richness","No. Species per Plot")
Average<-c("",round(mean(FORE$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(FORE$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(mean(FORE$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(mean(FOREA$Species=="FEAR2", na.rm=TRUE), digits=2),"","N/A","",
           round(mean(FOREA$Species=="PIFL2", na.rm=TRUE), digits=2),round(mean(FOREA$Species=="PIED", na.rm=TRUE), digits=2),round(mean(FOREA$Species=="PSME", na.rm=TRUE), digits=2),
           "",round(mean(FOREG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Minimum<-c("",round(min(FORE$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(FORE$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(min(FORE$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(min(FORE$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(min(FORE$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(min(FORET$HeightWoody, na.rm=TRUE), digits=2),round(mean(FORES$HeightWoody, na.rm=TRUE), digits=2),"",
           round(min(FOREA$Species=="FEAR2", na.rm=TRUE), digits=2),"","N/A","",
           round(min(FOREA$Species=="PIFL2", na.rm=TRUE), digits=2),round(min(FOREA$Species=="PIED", na.rm=TRUE), digits=2),round(min(FOREA$Species=="PSME", na.rm=TRUE), digits=2),"",round(min(FOREG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
Maximum<-c("",round(max(FORE$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(FORE$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(max(FORE$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(max(FORE$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(max(FORE$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(max(FORET$HeightWoody, na.rm=TRUE), digits=2),round(mean(FORES$HeightWoody, na.rm=TRUE), digits=2),"",
           round(max(FOREA$Species=="FEAR2", na.rm=TRUE), digits=2),"","N/A","",
           round(max(FOREA$Species=="PIFL2", na.rm=TRUE), digits=2),round(max(FOREA$Species=="PSME", na.rm=TRUE), digits=2),round(max(FOREA$Species=="PIED", na.rm=TRUE), digits=2),"",
           round(max(FOREG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
St.Dev.<-c("",round(sd(FORE$Rock.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(FORE$Total.Litter.Cover.Pct.First.Hit, na.rm=TRUE), digits=2),round(sd(FORE$Bare.Soil.Pct, na.rm=TRUE), digits=2),
           ...
           round(sd(FORE$tree, na.rm=TRUE),digits=2),round(sd(FORE$noxiousforb, na.rm=TRUE),digits=2),round(sd(FORE$nonnoxiousforb),digits=2),"",
           round(sd(FORE$Average.Grass.Height.cm, na.rm=TRUE),digits=2),round(sd(FORE$Average.Forb.Height.cm, na.rm=TRUE), digits=2),round(sd(FORET$HeightWoody, na.rm=TRUE), digits=2),round(mean(FORES$HeightWoody, na.rm=TRUE), digits=2),"",
           round(sd(FOREA$Species=="FEAR2", na.rm=TRUE), digits=2),"","N/A","",
           round(sd(FOREA$Species=="PIFL2", na.rm=TRUE), digits=2),round(sd(FOREA$Species=="PIED", na.rm=TRUE), digits=2),round(sd(FOREA$Species=="PSME", na.rm=TRUE), digits=2),"",
           round(sd(FOREG$Gap.Cover.25.to.50.Pct, na.rm=TRUE), digits=2),
...
#figuring SLVFO strata design
View(strata)

BH<-subset(strata,Actual.Eco.Site=="BH")
LB<-subset(strata,Actual.Eco.Site=="LB")
LOA<-subset(strata,Actual.Eco.Site=="LOA")
MO<-subset(strata,Actual.Eco.Site=="MO")
OTH<-subset(strata,Actual.Eco.Site=="OTH")
ROF<-subset(strata,Actual.Eco.Site=="ROF")
SAL<-subset(strata,Actual.Eco.Site=="SAL")
SAN<-subset(strata,Actual.Eco.Site=="SAN")
FORE<-subset(strata,Actual.Eco.Site=="FORE")


summary(BH$RANGE_SITE)
summary(BH$MUSYM)

summary(LB$RANGE_SITE)
summary(LB$MUSYM)

summary(LOA$RANGE_SITE)
summary(LOA$MUSYM)

summary(MO$RANGE_SITE)
summary(MO$MUSYM)

summary(OTH$RANGE_SITE)
summary(OTH$MUSYM)

summary(ROF$RANGE_SITE)
summary(ROF$MUSYM)

summary(SAL$RANGE_SITE)
summary(SAL$MUSYM)

summary(SAN$RANGE_SITE)
summary(SAN$MUSYM)

summary(FORE$RANGE_SITE)
summary(FORE$MUSYM)
#assigning ESs
ESD<-read.csv("~/ESD_S.csv")
Plotdata<-read.csv("~/Plotdata.csv")
ESD$Actual.Eco.Site<-Plotdata$Actual.Eco.Site[match(ESD$PrimaryKey,Plotdata$PrimaryKey)]

write.csv(ESD,"ESD_S_Ecosite.csv")
ESD<-read.csv("~/ESD_S_Ecosite.csv")

BH<-subset(ESD,Actual.Eco.Site=="BH")
LB<-subset(ESD,Actual.Eco.Site=="LB")
LOA<-subset(ESD,Actual.Eco.Site=="LOA")
MO<-subset(ESD,Actual.Eco.Site=="MO")
OTH<-subset(ESD,Actual.Eco.Site=="OTH")
ROF<-subset(ESD,Actual.Eco.Site=="ROF")
SAL<-subset(ESD,Actual.Eco.Site=="SAL")
SAN<-subset(ESD,Actual.Eco.Site=="SAN")
FORE<-subset(ESD,Actual.Eco.Site=="FORE")
